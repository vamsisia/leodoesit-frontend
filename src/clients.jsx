...
export default function Clients() {
  ...
  // 🔥 FIX: Added the error alert to stop silent failures
  const handleSaveEdit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Now it will tell you exactly why it failed!
    ...
    <div>
      ...
      <div style={styles.tableContainer}>
        {loading ? (
          ...
          <p style={{ padding: '20px', color: '#6B7280', fontStyle: 'italic' }}>No clients found.</p>
        ) : (
              ...
              {filteredClients.map((client) => (
                <tr key={client.id} style={styles.tableRow}>
                  ...
                  <td style={{...styles.td, textAlign: 'center'}}>
                    <button style={styles.insightBtn}>📊 Stats</button>
                    <button 
                      onClick={() => {
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid #E5E7EB', paddingBottom: '15px', marginBottom: '20px' }}>
              <div>
                ...
                <span style={{ fontSize: '14px', color: '#6B7280' }}>
                    {viewingClient.is_active !== false ? '🟢 Active Client' : '⚫ Inactive Client'}
                </span>
              </div>
      ...
      {editingId && (
        <div style={styles.modalOverlay}>
          <div style={styles.modalBox}>
            <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid #E5E7EB', paddingBottom: '15px', marginBottom: '20px' }}>
              <h2 style={{ margin: 0, color: '#111827' }}>Edit Client</h2>
            ...
            <form onSubmit={handleSaveEdit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              ...
              <div style={{ backgroundColor: '#F9FAFB', padding: '12px 15px', borderRadius: '6px', border: '1px solid #E5E7EB', display: 'flex', alignItems: 'center', gap: '10px' }}>
                <input 
                  type="checkbox" 
                  name="is_active" 
                ...
                />
                <label style={{ fontSize: '14px', color: '#111827', fontWeight: 'bold', cursor: 'pointer' }}>
                  Client is Active
                </label>
              </div>
...
const styles = {
  ...
  badgeActive: { backgroundColor: '#D1FAE5', color: '#047857', padding: '4px 12px', borderRadius: '12px', fontSize: '13px', fontWeight: 'bold' },
  badgeInactive: { backgroundColor: '#F3F4F6', color: '#6B7280', padding: '4px 12px', borderRadius: '12px', fontSize: '13px', fontWeight: 'bold' },
  ...
  input: { padding: '12px 15px', borderRadius: '6px', border: '1px solid #D1D5DB', fontSize: '15px', outline: 'none' },
