...
//                 return (
//                   <tr key={ts.id} onClick={() => setDrawerItem(ts)} style={styles.tableRow}>
//                     {viewMode === 'PENDING' && (
...
//                     </td>
//                     <td style={styles.td}>
//                       <strong style={{ color: isOvertime ? '#DC2626' : '#111827', fontSize: '16px' }}>{ts.total_hours}</strong>
...
//                         <div style={{ padding: '10px', fontSize: '12px', color: '#4B5563', textAlign: 'center' }}>Click to enlarge image {i+1}</div>
//                       </a>
//                     ))}
//                   </div>
//                 ) : (
...
//   drawerPanel: { width: '450px', backgroundColor: 'white', height: '100%', boxShadow: '-5px 0 15px rgba(0,0,0,0.1)', overflowY: 'auto' },
...
//   imageCard: { display: 'block', border: '1px solid #E5E7EB', borderRadius: '8px', overflow: 'hidden', textDecoration: 'none', transition: 'transform 0.2s' },
//   imagePreview: { height: '150px', backgroundColor: '#F9FAFB', backgroundSize: 'cover', backgroundPosition: 'center', borderBottom: '1px solid #E5E7EB' },
          ...
          <table style={styles.table}>
            <thead>
              <tr style={styles.tableHead}>
                ...
                <th style={styles.thSortable} onClick={() => handleSort('period_start')}>Billing Period</th>
                <th style={{...styles.thSortable, textAlign: 'right'}} onClick={() => handleSort('total_hours')}>
                  Hours {sortConfig.key === 'total_hours' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : ''}
                </th>
                <th style={styles.th}>Proof of Work</th>
                <th style={styles.th}>Status</th>
